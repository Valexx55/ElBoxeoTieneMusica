...
/**
 * Esta clase debería ir un paquete Utils...ya irá..
 * 
 * Se trata de recibir una fecha AAAA-MM-DD
 * y devolver Dia de Mes de Año
 * 
 * 
 * @author Vale
 *
...
public class TraduceFecha {
	...
	public static String fromNominal2Numeric (String fecha_nominal)
	{
		...
		String mes_nominal = null;
			...
			Log.d(TraduceFecha.class.getCanonicalName(), "Fecha recibida en formato numérico " + fecha_nominal);
		
			//13 de Enero de 2010
			int pos_espacio_fin_mes = fecha_nominal.indexOf(" ", 6); //6 es la posición donde empieza el mes
			int pos_espacio_prev_anio = fecha_nominal.indexOf(" ", pos_espacio_fin_mes+1); //6 es la posición donde empieza el mes
	...
	public static String  fromNumeric2Nominal  (String fecha)
	{
		...
		String mes_nominal = null;
			...
			Log.d(TraduceFecha.class.getCanonicalName(), "Fecha recibida en formato numérico " + fecha);
